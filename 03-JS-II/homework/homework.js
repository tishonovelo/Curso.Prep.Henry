...
function saludo(idioma) {
  ...
  switch (idioma) {
    ...
    case undefined: return "Hola!"; break;
    default: return "Hola!";
  } 
}
...
function colors(color) {
  ...
  // break; <-- hará que se finalice el código y se ejecute nuevamente, a veces no es necesario ponerlo pero sí es buena práctica
}
...
function esEntero(numero) {
  ...
  // Tu código:
  // Math.floor(numero): 5 ---> 5,   4.6 ---> 4,  3.2 ---> 3
